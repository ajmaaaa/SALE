...
class ChatController extends Controller
{
    ...
    protected function ensureRoomAndMembership(int $courseId, ?User $user = null): Room
    {
        ...
        if ($room->members()->count() === 0) {
            ...
            foreach ($allUsers as $u) {
                $r = in_array($u->role?->name, [Role::DOSEN, Role::KAPRODI], true) ? 'dosen' : 'mahasiswa';
     ...
     * Cursor-based pagination (Section 3.3 & 6 of desain-sistem-chat-diskusi.md)
     */
    public function getMessages(Request $request, int $course): JsonResponse
    {
        ...
        // Ambil 30 pesan terbaru lalu balik urutannya agar terurut kronologis (lama -> baru)
        ...
        // Ambil pesan-pesan yang di-pin (Section 10.4)
    ...
    public function sendMessage(Request $request, int $course): JsonResponse
    {
        ...
        // Simpan Mention (@user) sesuai Bagian 8.2
     ...
     * Pin / Unpin message (Dosen only, Bagian 10.2).
     */
     ...
     * Soft delete message (Bagian 10.1 & 10.2).
     */
     ...
     * Return list of members for mention autocomplete dropdown (Bagian 8.1).
     */
