...
@section('content')
<div class="mx-auto max-w-3xl"><a class="quiet-link" href="{{ route('dosen.course.index') }}">← Course saya</a><h1 class="page-heading mt-5">Tambah course</h1><p class="page-description">Siapkan identitas kelas. Materi dan tugas ditambahkan setelah course dibuat.</p>
<form method="post" enctype="multipart/form-data" action="{{ route('dosen.course.store') }}" class="surface mt-7 space-y-6 p-6 sm:p-8">@csrf
