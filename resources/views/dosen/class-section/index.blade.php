...
@section('title', 'Daftar Kelas | SALE')
@section('header', 'Daftar Kelas Saya')
...
<div class="space-y-6">
    <header>
        <nav class="flex items-center gap-2 text-xs text-muted mb-1">
            ...
            <span>/</span>
            <span class="text-ink font-semibold">Penilaian</span>
        </nav>
        <h1 class="page-heading">Daftar Kelas Saya</h1>
        <p class="page-description">Kelola penilaian berbasis OBE untuk setiap kelas yang Anda ampu pada semester berjalan.</p>
    </header>
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            @foreach($sections as $section)
                ...
                <div class="surface p-5 flex flex-col gap-4">
                    ...
                    <a href="{{ route('dosen.penilaian.rekap', $section->id) }}" class="button-primary text-xs mt-1">
                        Kelola Penilaian
                    </a>
                </div>
            @endforeach
