...
@php
    $uasStudents = [
        ['no' => '01', 'initials' => 'AP', 'name' => 'Andi Pratama',  'number' => '2024081001', 'score' => 84, 'cpmk1' => 86, 'cpmk2' => 80, 'submitted_at' => '10 Jan 2027, 13:45 WIB'],
        ['no' => '02', 'initials' => 'BS', 'name' => 'Budi Santoso',  'number' => '2024081002', 'score' => 78, 'cpmk1' => 80, 'cpmk2' => 75, 'submitted_at' => '10 Jan 2027, 14:10 WIB'],
        ['no' => '03', 'initials' => 'CL', 'name' => 'Citra Lestari', 'number' => '2024081003', 'score' => 92, 'cpmk1' => 95, 'cpmk2' => 90, 'submitted_at' => '10 Jan 2027, 11:20 WIB'],
        ['no' => '04', 'initials' => 'DS', 'name' => 'Dedi Saputra',  'number' => '2024081004', 'score' => 64, 'cpmk1' => 68, 'cpmk2' => 60, 'submitted_at' => '09 Jan 2027, 23:58 WIB'],
        ['no' => '05', 'initials' => 'EW', 'name' => 'Eka Wahyuni',   'number' => '2024081005', 'score' => 88, 'cpmk1' => 90, 'cpmk2' => 86, 'submitted_at' => '10 Jan 2027, 09:15 WIB'],
        ['no' => '06', 'initials' => 'FM', 'name' => 'Fajar Maulana', 'number' => '2024081006', 'score' => 77, 'cpmk1' => 80, 'cpmk2' => 73, 'submitted_at' => '10 Jan 2027, 14:02 WIB'],
    ];
@endphp
    ...
    <div class="assessment-overview-layout flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div class="space-y-2 flex-1">
            <div class="flex items-center gap-2">
                ...
                <span class="status font-semibold text-muted bg-canvas text-[11px]">Bobot: 30%</span>
            </div>
            <h2 class="text-xl font-bold text-ink">Ujian Akhir Semester (UAS)</h2>
            <p class="text-xs text-muted leading-relaxed max-w-2xl">
                Penilaian komprehensif akhir semester menguji seluruh indikator capaian pembelajaran lulusan (CPMK 01, CPMK 02, dan CPMK 03) secara menyeluruh melalui studi kasus industri terintegrasi.
            </p>
            <div class="assessment-meta flex flex-wrap items-center gap-4 pt-1 text-xs text-muted">
                <span class="flex items-center gap-1.5">
                    ...
                    Format: <strong class="text-ink font-semibold">Ujian Komprehensif &amp; Demonstrasi Sistem</strong>
                </span>
                <span class="flex items-center gap-1.5">
                    ...
                    CPMK Terukur: <strong class="text-ink font-semibold">CPMK 01, CPMK 02, CPMK 03</strong>
                </span>
            </div>
        </div>
    ...
    <table class="admin-table assessment-table w-full" id="students-table">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center min-w-[130px]">NILAI UAS <span class="block font-normal mt-1">(BOBOT 30%)</span></th>
        ...
        <tbody>
            @foreach($uasStudents as $stu)
                <tr class="student-row" data-name="{{ strtolower($stu['name']) }}" data-number="{{ $stu['number'] }}" data-status="{{ $stu['status_key'] ?? ($stu['cpmk1'] >= 50 ? ($stu['cpmk2'] >= 80 ? 'memenuhi' : 'evaluasi') : 'belum') }}">
...
<div class="surface assessment-savebar p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div class="flex items-center gap-3 text-xs text-muted">
        ...
        <div>
            <p class="font-bold text-ink">Kalkulasi Otomatis OBE (UAS)</p>
            <p class="text-muted">Nilai UAS berkontribusi 30% pada kalkulasi akhir CPMK 01, CPMK 02, dan CPMK 03.</p>
        </div>
    </div>
...
{{-- Script: Hitung ulang Nilai UAS dari rata-rata CPMK --}}
<script>
