    ...
    <div class="flex gap-0 rounded-2xl border border-line/70 overflow-hidden shadow-sm min-h-[70vh]" style="height: calc(100vh - 14rem);">
        ...
        <div class="flex-1 overflow-y-auto border-r border-line/70 bg-white">
            <div class="sticky top-0 z-10 bg-white border-b border-line/60 px-5 py-3">
                <p class="text-[11px] font-bold tracking-wider text-muted uppercase">PENILAIAN</p>
                    ...
                    <div class="px-5 py-4 space-y-3" id="essay-panel-{{ $loop_i }}">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-[11px] font-bold tracking-wider text-muted uppercase">SOAL {{ $loop_i + 1 }} · ESAI · Maks. {{ (float)$max }} poin</span>
                            </div>
                            @if($isGraded)
                        ...
                        <form method="POST"
                            ...
                            <div class="flex items-center gap-2 flex-1">
                                <span class="text-xs font-semibold text-muted">Skor:</span>
                                <input
                                    type="number"
                                    name="score"
                                ...
                                <div class="flex items-center gap-3 text-xs ml-1">
                                    ...
                                    <span class="text-line">·</span>
                                    <span class="text-[11px] text-muted">Porsi soal di CPMK: {{ round($essayItem['porsi_soal'], 2) }}%</span>
                                </div>
                            </div>
                            <button type="submit"
