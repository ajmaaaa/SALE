...
Route::post('/mahasiswa/notifikasi/baca-semua', [LearningController::class, 'readAllNotifications'])->name('mahasiswa.notifications.read-all');
Route::post('/mahasiswa/notifikasi/bersihkan', [LearningController::class, 'clearNotifications'])->name('mahasiswa.notifications.clear');
Route::match(['get', 'post'], '/mahasiswa/notifikasi/{id}/baca', [LearningController::class, 'readNotification'])->whereNumber('id')->name('mahasiswa.notifications.read');
...
Route::post('/ai/login', [AiTutorController::class, 'login'])->name('ai.login');
Route::post('/ai/tasks/{assignment}', [AiTutorController::class, 'send'])->whereNumber('assignment')->name('ai.send');
